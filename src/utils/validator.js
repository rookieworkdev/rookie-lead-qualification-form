 ...
 * Replicates the "Lead Data Validation" code node
 */
 ...
 * Replicates the "Extract Domain" code node
 */
export function extractDomain(data) {
  ...
  if (data.email && data.email.includes('@')) {
    ...
    const personalDomains = [
      ...
      'yahoo.com', 'live.com', 'hotmail.se', 'outlook.se'
    ];
 ...
 * Replicates the "Normalize Company Data" code node
 */
 ...
 * Replicates the "Prepare Contact Data" code node
 */
